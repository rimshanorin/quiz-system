...
class UserController extends Controller
{
    ...
    function userSignup(Request $request)
    {
        ...
        if ($user) {
            ...
            if (Session::has('quiz-url')) {
                ...
                return redirect($url)->with('message-success', "User login successfully.Please check your email for verification");
            }
            return redirect('/')->with('message-success', "User login successfully.Please check your email for verification");
        }
    }
    ...
    function userLogin(Request $request)
    {
        ...
        if ($user) {
            ...
            if (Session::has('quiz-url')) {
                ...
                return redirect('/')->with('message-success',"User registered successfully.Please check your email for verification");
            }
        }
    }
    ...
    function mcq($id, $name)
    {
        ...
        if ($record->save()) {
            ...
            return "unable to start quiz,please try again";
        }
    }
    function submitAndNext(Request $request, $id)
    {
        ...
        if ($isExist < 1) {
            ...
            $mcq_record->select_answer = $request->option; //there was $record inplace of $request according to video
        ...
        if ($mcqData) {
            ...
            //  return $resultData=MCQ_Record::where(
            //     ['record_id','=', $currentQuiz['recordId']],
            //     ['is_correct','=', 1],
            //   )->count();
